...
<div class="header">
    <div class="header-wrap">
        ...
        <div class="blog-nav pull-right">
            ...
            <!--登录&&我的信息-->
            <a href="${pageContext.request.contextPath}/pages/diary_mine.jsp" class="personal pull-left">
...
<div class="container-wrap">
    <div class="container container-message">
        <div class="contar-wrap" id="contar-wrap">
            ...
            <form class="layui-form" action="${pageContext.request.contextPath}/diary/diaryAdd.do" method="post">
                ...
                <input id="testFile" name="diaryDoc" type="file">
