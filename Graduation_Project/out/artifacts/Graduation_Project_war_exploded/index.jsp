...
<div class="header">
    <div class="header-wrap">
        ...
        <div class="blog-nav pull-right">
            <ul class="layui-nav pull-left">
                ...
                <li class="layui-nav-item"><a href="${pageContext.request.contextPath}/diary/findByUsername.do?username=${sessionScope.username}">用户</a></li>
            </ul>
    ...
    <ul class="pop-nav" id="pop-nav">
        ...
        <li><a href="${pageContext.request.contextPath}/pages/admin.jsp">管理员</a></li>
        <li><a href="">用户</a></li>
    </ul>
</div>
<!--头部结尾-->
